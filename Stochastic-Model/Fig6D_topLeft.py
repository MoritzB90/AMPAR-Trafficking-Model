...
if saveData==1:
    np.save('Data_FRAP\\Time_tl.npy', Time)    
    np.save('Data_FRAP\\B_N_tl.npy', B_N)
    np.save('Data_FRAP\\U_N_tl.npy', U_N)
    np.save('Data_FRAP\\B_notBleached_N_tl.npy', B_notBleached_N)
    np.save('Data_FRAP\\U_notBleached_N_tl.npy', U_notBleached_N)
    
#%%

if loadData==1:
    Time=np.load('Data_FRAP\\Time_tl.npy')
    B_N=np.load('Data_FRAP\\B_N_tl.npy')
    U_N=np.load('Data_FRAP\\U_N_tl.npy')
    B_notBleached_N=np.load('Data_FRAP\\B_notBleached_N_tl.npy')
    U_notBleached_N=np.load('Data_FRAP\\U_notBleached_N_tl.npy')
...
sns.lineplot(x=dataPoints_x_M,y=dataPoints_y_M, color='k', alpha=0.6, linewidth=2, marker='d', label='Makino 2009')
...
if SaveFig==1:
    print('Save')
    fig.savefig('Figures\\Fig6D_topLeft_var.png', bbox_inches="tight", dpi=400)
    fig.savefig('Figures\\Fig6D_topLeft_var.svg', bbox_inches="tight", dpi=400)
